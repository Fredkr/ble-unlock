...
React.render( React.createElement(Settings, null),
    document.getElementById('settings')
);
React.render( React.createElement(ScannerStatus, null),
    document.getElementById('status')
);

},{"react":186,"scannerStatus":2,"settings":11}],2:[function(require,module,exports){
'use strict';
var React = require('react');
var ScannerStatus = React.createClass({displayName: "ScannerStatus",
    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: "status-container center"}, 
                React.createElement("div", {className: classString}, 
                    React.createElement("p", null, " ", this.state.isScanning ? 'Scanning' : 'Turned off', " ")
                ), 
                React.createElement("button", {className: "button-xlarge pure-button", 
...
var DeviceList = React.createClass({displayName: "DeviceList",
    ...
    synchronize: function() {
        console.log('sync');
        React.render( React.createElement(DeviceSynchronizer, {
    ...
    render: function() {
        return (
            React.createElement("div", null, 
                ...
                React.createElement("table", {className: "pure-table pure-table-horizontal"}, 
                    React.createElement("thead", null, 
                        React.createElement("tr", null, 
                            ...
                            React.createElement("th", {className: "col-name"}, "Device"), 
                            React.createElement("th", {className: "col-uuid"}, "GUID"), 
                            React.createElement("th", {className: "col-buttons"})
                        )
                    ), 
                    React.createElement("tbody", null, 
                        this.state.devices.map(function(device, index) {
                            return (React.createElement("tr", null, 
                                React.createElement("td", {className: "col-id"}, index + 1), 
                                React.createElement("td", {className: "col-name"}, device.value.name), 
                                React.createElement("td", {className: "col-uuid"}, device.value.uuid), 
                                React.createElement("td", {className: "col-buttons"}, 
                                    React.createElement("button", {className: "pure-button", 
                ...
                React.createElement("button", {className: "pure-button scanner-button", 
                    onClick: this.synchronize}, 
                    "Scan for new device ", React.createElement("i", {className: "fa fa-search"})
                )
            )
        );
    }
...
},{"devicesynchronizer":5,"react":186}],4:[function(require,module,exports){
'use strict';
var React = require('react/addons');
var NewDeviceResult = require('newDeviceResult');

var DeviceSynchronizer = React.createClass({displayName: "DeviceSynchronizer",
    propTypes: {
    ...
    render: function (){
        ...
        if(this.state.synchronizing) {
            return(
            React.createElement("div", null, 
                React.createElement("div", {className: "device-synchronizer-container"}, 
                    this.state.error
                        ? React.createElement("h2", null, " No devices found ")
                        : React.createElement("h2", null, " Scanning for devices (very) close by "), 
                    
                    React.createElement("div", {className: divClasses}, 
                        React.createElement("i", {className: iconClasses, 
                            onClick: this.reset}), 
                        this.state.error &&

                            React.createElement("p", null, " Try again ")
                        
                    )
                )
        )
        ); }else {
            return (React.createElement(NewDeviceResult, {
...
},{"newDeviceResult":7,"react/addons":14}],5:[function(require,module,exports){
arguments[4][4][0].apply(exports,arguments)
},{"dup":4,"newDeviceResult":7,"react/addons":14}],6:[function(require,module,exports){
'use strict';
var React = require('react');
var NewDeviceItem = React.createClass({displayName: "NewDeviceItem",
    getInitialState: function() {
        return {
            name: '',
            uuid: ''
    ...
    render: function() {
        return (React.createElement("tr", null, 
                    React.createElement("td", {className: "col-id"}, "?"), 
                    ...
                    React.createElement("td", {className: "col-uuid"}, 
                        React.createElement("input", {
                    ...
                    React.createElement("td", {className: "col-buttons"}, 
                        React.createElement("button", {className: "button-xsmall pure-button", 
...
'use strict';
var React = require('react');
var NewDeviceResult = React.createClass({displayName: "NewDeviceResult",
    propTypes: {
    ...
    render: function() {
            return (React.createElement("div", {className: "device-synchronizer-container"}, 
                React.createElement("h2", null, " We found devices!"), 
                React.createElement("h3", null, "select one and give it a name"), 
                React.createElement("table", {className: "pure-table pure-table-horizontal"}, 
                    React.createElement("thead", null, 
                        React.createElement("tr", null, React.createElement("th", null, "Devices found"))
                    ), 
                    React.createElement("tbody", null, 
                        this.props.devices.map(function(result) {
                            var selected = result === this.state.uuid ? 'selected' : '';
                            return (React.createElement("tr", null, 
                                React.createElement("td", {className: selected, 
                ...
                React.createElement("h2", null, " Give it a name "), 
                React.createElement("div", null, 
                    React.createElement("input", {
                ...
                React.createElement("button", {className: "button-xlarge pure-button", 
                    ...
                    onClick: this.saveDevice}, "Save device")
            ));
        }
});
    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: "general"}, 
                React.createElement("h3", {className: "line"}, " Password "), 
                React.createElement("div", {className: "container"}, 
                    React.createElement("p", {className: "left"}, " ", description, " "), 
...
'use strict';
var React = require('react');
var ScannerMode = React.createClass({displayName: "ScannerMode",
    propTypes: {
        getSettingSource: React.PropTypes.string.isRequired,
        saveSettingSource: React.PropTypes.string.isRequired
    },
    ...
    render: function() {
        return (
            React.createElement("div", {className: "general"}, 
                React.createElement("h3", {className: "line"}, " Proximity Mode "), 
                React.createElement("div", {className: "container"}, 
                    React.createElement("p", {className: "left"}, " Let the app lock and unlock your computer automatically"), 
                    React.createElement("div", {className: "center two-column"}, 
                        React.createElement("form", {className: "pure-radio"}, "Manual mode", 
                            React.createElement("input", {
                        ...
                        React.createElement("form", {className: "pure-radio"}, "Proximity mode", 
                            React.createElement("input", {
                                checked: this.state.proximityMode, 
                                className: "radio-input", 
                                name: "optionsRadios", 
...
var ScannerSettings = React.createClass({displayName: "ScannerSettings",
    propTypes: {
    ...
    render: function () {
        return (
            React.createElement("div", {className: "settings-general-container"}, 
            React.createElement(Password, {
                ...
                showToastMessage: this.props.showToastMessage}), 
            React.createElement(ScannerMode, {
                getSettingSource: "http://localhost:3001/get/setting/", 
                saveSettingSource: "http://localhost:3001/post/setting/"})
            )
        );
...
},{"password":8,"react":186,"scannerMode":9}],11:[function(require,module,exports){
'use strict';
var React = require('react');
            ...
            React.createElement("div", {className: "settings-container"}, 
                ...
                React.createElement("div", {className: "settings-content"}, 
                    React.createElement("div", {className: "settings-header"}, 
                        React.createElement("i", {className: "fa fa-cog fa-spin settings-icon"})
                    ), 
                    React.createElement(ScannerSettings, {
...
},{"deviceList":3,"react":186,"scannerSettings":10,"toast":12}],12:[function(require,module,exports){
'use strict';
var React = require('react');
    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: style}, 
                React.createElement("h4", null, " ", this.props.message, " ")
            )
        );
    }
});
...
},{"react":186}],13:[function(require,module,exports){
...
},{"./lib/React":44}]},{},[1,2,3,4,6,7,8,9,10,11,12]);
